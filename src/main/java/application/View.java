    ...
    public class View extends Application  {
        ...
        private static app.SoftwareApp SoftwareApp;
        ...
        public void start(Stage primaryStage) {
            ...
            try {
                theModel = new Model(this, View.SoftwareApp);
        ...
        public void manageProjectPage (String projectID, String projectName) {
            try {
                ...
                // Set the model and view for the new controller instance
                manageProjectPageController.setModelAndView(theModel, this, this.SoftwareApp);
                // Set the project for the new controller instance
        ...
        public static void main(String[] args) {
            ...
            setSoftwareApp(softwareApp);
            launch(args);
        }



        public static void setSoftwareApp(SoftwareApp softwareApp) {
            View.SoftwareApp = softwareApp;
        }
